...
public class PlayerUI : MonoBehaviour
{
    ...
    void Update()
    {
        if (ThisPlayer.GetComponent<Player>().isReady && (DuelStateManager.duelStateType == GameState.DuelStateMode.Move || DuelStateManager.duelStateType == GameState.DuelStateMode.Attack || DuelStateManager.playerStateType == GameState.PlayerStateMode.Damage))
        {
